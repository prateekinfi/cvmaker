    ...
    template4:{
        ...
        awards: function (id, value) {
            ...
            value.forEach(awardDetail => {
                let li = `   <li class="py-2">
                               <label contenteditable="true" class="mb-0 font-weight-bold cvmaker-editable award_detail">${awardDetail.award_detail},</label>
                               <label contenteditable="true" class="mb-0 font-weight-bold cvmaker-editable year">${awardDetail.year}</label>
                               <div id='course' contenteditable="true" class="cvmaker-editable organization">${awardDetail.organization}</div>
        ...
        experience: function (id, value) {
            ...
            value.forEach((experienceDetails, idx) => {
                let div = `  <div class="col-12 py-2">
                                ...
                                <h6><span id='company' contenteditable="true" class="cvmaker-editable organization">${experienceDetails.organization}</span>
                                    <span id='work_duration' contenteditable="true" class="cvmaker-editable work_duration">${experienceDetails.work_duration}</span></h6>
                            </div>
                                `;
...
var DEFAULT_SNIPPETS = {
    ...
    EXPERIENCE: ` <div class="col-12 py-2">
    <h5><span id='designation' contenteditable="true" class="cvmaker-editable designation">YOGA INSTRUCTOR</span></h5>
    <span id='remove' onclick='deletePoint(this)'><i class="fa fa-minus-circle noPrint" aria-hidden="true"></i></span>

    <h6><span id='company' contenteditable="true" class="cvmaker-editable organization">Anytime Fitness</span>
        <span id='work_duration' contenteditable="true" class="cvmaker-editable work_duration">(2011-present)</span></h6>
</div>` 
}
